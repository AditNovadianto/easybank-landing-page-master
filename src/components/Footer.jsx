const medias = [
  <svg
    className="fill-white hover:fill-Link transition-all duration-300"
...
const Footer = () => {
  return (
    <div className="mt-40 p-10 bg-Dark-Blue">
      <div className="max-w-[1270px] m-auto flex items-center flex-col gap-10 md:flex-row justify-between">
        <div className="md:flex items-center gap-10">
          <div>
            ...
            <div className="flex itemx-center justify-center mt-10 gap-5">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center mt-10 md:mt-0 gap-3 md:ml-20">
            <div className="flex flex-col gap-5">
              {links[0].map((link, index) => (
                <a
                  key={index}
                  className="block hover:text-Link transition-all font-Public-Sans text-base text-Very-Light-Gray font-light text-center md:text-left"
                  href="#"
                >
                  {link}
                </a>
            ...
            <div className="flex flex-col gap-5 md:ml-28 mt-2 md:mt-0">
        ...
        <div className="flex items-center flex-col mt-2">
          <button className="mt-8 md:mt-0 px-9 shdw transition-all py-3 text-sm font-semibold text-Light-Grayish-Blue m-auto md:mr-0 block font-Public-Sans bg-gradient-to-r from-Lime-Green to-Bright-Cyan rounded-full">
            Request Invite
          </button>

          <p className="font-Public-Sans text-base text-Grayish-Blue text-center text-medium mt-10">
